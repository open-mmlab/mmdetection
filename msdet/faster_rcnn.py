...
################################# Ablation ##################################
@DETECTORS.register_module()
class FasterRCNN_TS_TEST(TwoStageDetector):
    """Implementation of `Faster R-CNN <https://arxiv.org/abs/1506.01497>`_"""
    def __init__(self,
                 backbone,
                 rpn_head,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(FasterRCNN_TS_TEST, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
        ...
        # Teacher Network
        teacher_cfg.model.type = 'FasterRCNNCont_test'
        teacher_cfg.model.roi_head.type = 'ContRoIHead'
        self.teacher_cfg = teacher_cfg
...
@DETECTORS.register_module()
class FasterRCNNCont_test(TwoStageDetector):
    """Implementation of `Faster R-CNN <https://arxiv.org/abs/1506.01497>`_"""
    def __init__(self,
                 backbone,
                 rpn_head,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(FasterRCNNCont_test, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
