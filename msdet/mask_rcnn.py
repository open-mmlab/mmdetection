...
class MaskRCNN_TS(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MaskRCNN_TS, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
        ...
        # Teacher Network
        teacher_cfg.model.type = 'MaskRCNNCont'
...
@DETECTORS.register_module()
class MaskRCNNCont(TwoStageDetector):
    """Implementation of `Mask R-CNN <https://arxiv.org/abs/1506.01497>`_"""
    def __init__(self,
                 backbone,
                 rpn_head,
                 roi_head,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MaskRCNNCont, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
