...
if __name__ == "__main__":
    ...
    parser.add_argument("--ann", default="data/objects365v2/annotations/zhiyuan_objv2_train.json")
    parser.add_argument("--fix_name_map", default="tools/dataset_converters/zhiyuan_objv2_train_names_fix.csv")
