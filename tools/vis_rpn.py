...
def main():
    args = parse_args()
    args.config = '/SSDb/heeseon/src/mmdetection/configs/faster_rcnn/coco_vis_faster_rcnn_r50_c4_1x.py'
    args.checkpoint = '/SSDb/heeseon/src/mmdetection/checkpoints/faster_rcnn_r50_caffe_c4_1x_coco_20220316_150152-3f885b85.pth'
