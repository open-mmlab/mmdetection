...
model = dict(
    ...
    neck=dict(
        type='SSDNeck',
        in_channels=(144, 288),
        out_channels=(144, 288, 512, 256, 256, 128),
    ...
    bbox_head=dict(
        type='SSDHead',
        in_channels=(144, 288, 512, 256, 256, 128),
        num_classes=80,
        use_depthwise=True,
        norm_cfg=dict(type='BN', eps=0.001, momentum=0.03),
        act_cfg=dict(type='ReLU6'),
...
data_root = '/media/volume3/coco2017/'
img_norm_cfg = dict(
...
checkpoint_config = dict(interval=1, max_keep_ckpts=5, by_epoch=True)
custom_hooks = [
