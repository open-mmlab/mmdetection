...
| :-------: | :---: | :-----: | :------: | :------: | :----: | :-----------------------------------------------------------------------------------------------------------------------------: | :----------------------: |
| ResNet-50 | caffe |   1x    |   True   |   3.3    |  40.2  | [config](https://github.com/open-mmlab/mmdetection/tree/dev-3.x/configs/centernet/centernet-update_r50-caffe_fpn_ms-1x_coco.py) | [model](<>) \| [log](<>) |
