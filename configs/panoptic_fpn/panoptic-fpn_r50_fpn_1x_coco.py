...
with read_base():
    from mmdet.configs._base_.models.mask_rcnn_r50_fpn import *
    from mmdet.configs._base_.datasets.coco_panoptic import *
    from mmdet.configs._base_.schedules.schedule_1x import *
