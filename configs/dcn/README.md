...
| R-50-FPN         | Cascade Mask | pytorch | dconv(c3-c5)  | -      | 1x      | 6.0  | 8.3  | 44.4 | 38.6 | [model](https://open-mmlab.s3.ap-northeast-2.amazonaws.com/mmdetection/v2.0/dcn/cascade_mask_rcnn_r50_fpn_dconv_c3-c5_1x_coco.py/cascade_mask_rcnn_r50_fpn_dconv_c3-c5_1x_coco.py_20200202-42e767a2.pth) &#124; [log](https://open-mmlab.s3.ap-northeast-2.amazonaws.com/mmdetection/v2.0/dcn/cascade_mask_rcnn_r50_fpn_dconv_c3-c5_1x_coco.py/cascade_mask_rcnn_r50_fpn_dconv_c3-c5_1x_coco.py_20200202_010309.log.json) |
| R-101-FPN        | Cascade Mask | pytorch | dconv(c3-c5)  | -      | 1x      | 8.0  | 7.1  | 45.8 | 39.7 | [model](https://open-mmlab.s3.ap-northeast-2.amazonaws.com/mmdetection/v2.0/dcn/cascade_mask_rcnn_r101_fpn_dconv_c3-c5_1x_coco.py/cascade_mask_rcnn_r101_fpn_dconv_c3-c5_1x_coco.py_20200204-df0c5f10.pth) &#124; [log](https://open-mmlab.s3.ap-northeast-2.amazonaws.com/mmdetection/v2.0/dcn/cascade_mask_rcnn_r101_fpn_dconv_c3-c5_1x_coco.py/cascade_mask_rcnn_r101_fpn_dconv_c3-c5_1x_coco.py_20200204_134006.log.json) |
