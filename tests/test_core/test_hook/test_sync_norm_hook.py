...
from mmdet.core.hook import SyncNormHook


class TestSyncNormHook(TestCase):

    @patch('mmdet.core.hook.sync_norm_hook.get_dist_info', return_value=(0, 1))
    ...
    @patch('mmdet.core.hook.sync_norm_hook.get_dist_info', return_value=(0, 2))
