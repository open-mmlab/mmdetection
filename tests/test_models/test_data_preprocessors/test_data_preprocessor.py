...
class TestDetDataPreprocessor(TestCase):
    ...
    def test_pad_shape(self):
        ...
        batch_pad_shape = processor.get_pad_shape(data)
        self.assertEqual(batch_pad_shape, [(10, 15), (10, 15)])

        data = dict(inputs=[torch.randint(0, 256, (3, 11, 10))])
        self.assertEqual(processor.get_pad_shape(data), [(11, 10)])
