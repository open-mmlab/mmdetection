...
def test_csp_darknet_backbone():
    ...
    assert feat[4].shape == torch.Size((1, 1024, 1, 1))
    ...
    assert feat[1].shape == torch.Size((1, 64, 8, 8))
    assert feat[2].shape == torch.Size((1, 128, 4, 4))
    assert feat[3].shape == torch.Size((1, 256, 2, 2))
    assert feat[4].shape == torch.Size((1, 512, 1, 1))
    ...
    feat = model(imgs)
    assert feat[0].shape == torch.Size((1, 96, 32, 32))
    assert feat[1].shape == torch.Size((1, 192, 16, 16))
    assert feat[2].shape == torch.Size((1, 384, 8, 8))
    assert feat[3].shape == torch.Size((1, 768, 4, 4))
    assert feat[4].shape == torch.Size((1, 1152, 2, 2))
    assert feat[5].shape == torch.Size((1, 1536, 1, 1))
