...
from mmdet.models.dense_heads import YOLOXTOODHead


def test_yolox_tood_head_loss():
    ...
    feat = [
        torch.rand(1, 64, s // feat_size, s // feat_size)
    ...
    # random inputs
    self = YOLOXTOODHead(
        num_classes=4, in_channels=64, use_depthwise=True, train_cfg=train_cfg)
