...
def test_ssd_anchor_generator():
    ...
    featmap_sizes = [(37, 37), (18, 18), (9, 9)]
    anchor_generator = build_anchor_generator(anchor_generator_cfg)

    expected_base_anchors = [
        torch.Tensor([[-20.0000, -20.0000, 28.0000, 28.0000],
                      [-29.9411, -12.9706, 37.9411, 20.9706],
                      [-12.9706, -29.9411, 20.9706, 37.9411],
                      [-46.0000, -46.0000, 54.0000, 54.0000],
                      [-66.7107, -31.3553, 74.7107, 39.3553],
                      [-31.3553, -66.7107, 39.3553, 74.7107]]),
        torch.Tensor([[-67.0000, -67.0000, 83.0000, 83.0000],
                      [-98.0660, -45.0330, 114.0660, 61.0330],
                      [-45.0330, -98.0660, 61.0330, 114.0660],
                      [-121.9038, -35.3013, 137.9038, 51.3013],
                      [-35.3013, -121.9038, 51.3013, 137.9038],
                      [-93.0000, -93.0000, 109.0000, 109.0000],
                      [-134.8356, -63.4178, 150.8356, 79.4178],
                      [-63.4178, -134.8356, 79.4178, 150.8356],
                      [-166.9371, -50.3124, 182.9371, 66.3124],
                      [-50.3124, -166.9371, 66.3124, 182.9371],
                      [-118.5000, -118.5000, 134.5000, 134.5000],
                      [-170.8980, -81.4490, 186.8980, 97.4490],
                      [-81.4490, -170.8980, 97.4490, 186.8980],
                      [-211.1044, -65.0348, 227.1044, 81.0348],
                      [-65.0348, -211.1044, 81.0348, 227.1044]]),
        torch.Tensor([[-134.0000, -134.0000, 166.0000, 166.0000],
                      [-196.1320, -90.0660, 228.1320, 122.0660],
                      [-90.0660, -196.1320, 122.0660, 228.1320],
                      [-243.8076, -70.6025, 275.8076, 102.6025],
                      [-70.6025, -243.8076, 102.6025, 275.8076]])
    ]
    ...
    # check valid flags
    expected_valid_pixels = [8214, 4860, 405]
    ...
    assert anchor_generator.num_base_anchors == [6, 15, 5]
