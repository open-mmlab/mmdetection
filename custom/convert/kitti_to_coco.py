...
KITTI_PATH_TRAIN = "/home/chrissikek/repos/data/amazon/train"
KITTI_PATH_VAL = "/home/chrissikek/repos/data/amazon/val"
OUT_PATH = "/home/chrissikek/repos/data/amazon"
...
with open(f'{OUT_PATH}/train/coco_train.json', 'w') as fp:
    json.dump(cocos[0], fp)
with open(f'{OUT_PATH}/val/coco_val.json', 'w') as fp:
