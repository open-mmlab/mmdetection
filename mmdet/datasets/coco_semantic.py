...
class CocoSegDaset(ADE20KSemsegDataset):
    ...
    In segmentation map annotation for COCO, 0 stands for background, which
    ...
    METAINFO = dict(
        classes=('person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train',
                 ...
                 'grass', 'gravel', 'ground-other', 'hill', 'house', 'leaves', 'light',
                 'mat', 'metal', 'mirror-stuff', 'moss', 'mountain', 'mud', 'napkin', 'net',
