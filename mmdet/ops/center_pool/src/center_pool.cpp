...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def(
        "bottom_forward", &bottom_pool_forward, "Bottom Pool Forward",
        py::call_guard<py::gil_scoped_release>()
    );
    m.def(
        "bottom_backward", &bottom_pool_backward, "Bottom Pool Backward",
        py::call_guard<py::gil_scoped_release>()
    );
    m.def(
    ...
    m.def(
        "right_forward", &right_pool_forward, "Right Pool Forward",
        py::call_guard<py::gil_scoped_release>()
    );
    m.def(
    ...
    m.def(
        "top_backward", &top_pool_backward, "Top Pool Backward",
        py::call_guard<py::gil_scoped_release>()
    );
}
