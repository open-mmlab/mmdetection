...
from . import affine_grid_generator_cpp
...
class _AffineGridGenerator(Function):
    ...
    def forward(ctx, theta, size, align_corners):
        ...
        func = affine_grid_generator_cpp.affine_grid_generator_forward
    ...
    def backward(ctx, grad_output):
        ...
        func = affine_grid_generator_cpp.affine_grid_generator_backward
