...
class DINOHead(DeformableDETRHead):
    ...
    def forward(self, hs, inter_references):
        outputs_classes = []
        outputs_coords = []
    ...
    def loss_by_feat(self,
                     ...
                     enc_topk_scores: Tensor,
                     enc_topk_anchors: Tensor,
                     batch_gt_instances: InstanceList,
                     batch_img_metas: List[dict],
                     batch_gt_instances_ignore: OptInstanceList = None,
                     dn_meta=None) -> Dict[str, Tensor]:
        ...
        dn_meta_list = [[dn_meta for _ in batch_gt_instances_list]
        ...
        if dn_cls_scores is not None:
            ...
            dn_losses_cls, dn_losses_bbox, dn_losses_iou = self.loss_dn(
                dn_cls_scores, dn_bbox_preds, batch_gt_instances_list,
