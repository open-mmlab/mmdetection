...
class RTMDetHead(ATSSHead):
    ...
    def _init_layers(self):
        ...
        if self.with_centerness:
            self.rtm_obj = nn.Conv2d(self.feat_channels, 1, 3, padding=1)
    ...
    def loss_by_feat_single(self, anchors, cls_score, bbox_pred, labels,
                            label_weights, bbox_targets, alignment_metrics,
                            stride):
    ...
    def _get_targets_single(self,
        ...
        assign_result = self.assigner.assign(pred_instances, gt_instances,
                                             gt_instances_ignore)
        assign_metrics = assign_result.max_overlaps
        ...
        for gt_inds in class_assigned_gt_inds:
            gt_class_inds = pos_inds[sampling_result.pos_assigned_gt_inds ==
                                     gt_inds]
            norm_alignment_metrics[gt_class_inds] = assign_metrics[
                gt_class_inds]
