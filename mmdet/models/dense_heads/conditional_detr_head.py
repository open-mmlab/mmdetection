...
class ConditionalDETRHead(DETRHead):
    ...
    def forward(self, hidden_states: Tensor, reference_points) -> Tuple[Tensor, Tensor]:
        """"Forward function.
    ...
    def loss(self, hidden_states: Tensor, reference_points,
    ...
    def loss_and_predict(
            self, hidden_states: Tuple[Tensor], reference_points,
    ...
    def predict(self,
                hidden_states: Tuple[Tensor], reference_points,
