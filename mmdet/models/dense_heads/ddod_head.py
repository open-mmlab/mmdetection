...
class DDODHead(AnchorHead):
    ...
    def loss_cls_single(self, cls_score, labels,
    ...
    def loss(self,
        ...
        targets_com = self.preprocess_predictions_anchors(anchor_list,
                                                        valid_flag_list,
                                                        cls_scores,
                                                        bbox_preds,
                                                        img_metas,
        ...
        cls_targets = self.get_reg_targets(
            anchor_list,
            valid_flag_list,
            num_level_anchors,
        ...
        reg_targets = self.get_cls_targets(
            anchor_list,
            valid_flag_list,
            num_level_anchors,
            num_level_anchors_list,
    ...
    def preprocess_predictions_anchors(self,                     
                                       anchor_list,
                                       valid_flag_list,
                                       cls_scores,
                                       bbox_preds,
    ...
    def get_cls_targets(self,
        ...
        is_cls_assigner is True. Besides returning the targets as the parent 
