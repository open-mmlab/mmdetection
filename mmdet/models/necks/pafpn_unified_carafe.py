...
class PAFPN_UNIFIED_CARAFE(FPN):
    ...
    def __init__(self,
        ...
        super(PAFPN_UNIFIED_CARAFE, self).__init__(
            in_channels,
            out_channels,
            num_outs,
            start_level,
        ...
        #     self.extra_downsample_modules.append(CARAFE(out_channels,
        #                                          op='downsample',
        #                                          scale=2,
        #                                          c_mid=16))
    ...
    def forward(self, inputs):
        ...
        for i in range(self.used_backbone_levels - 1, 0, -1):
            ...
            laterals[i - 1] += self.upsample_modules[i-1](laterals[i])
        ...
        if self.num_outs > len(outs):
            ...
            if not self.add_extra_convs:
                for i in range(self.num_outs - self.used_backbone_levels):
                    ...
                    # outs.append(self.extra_downsample_modules[i](outs[-1]))
