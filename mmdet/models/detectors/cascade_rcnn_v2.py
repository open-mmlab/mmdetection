...
class CascadeRCNNV2(BaseDetector, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeRCNNV2, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(CascadeRCNNV2, self).init_weights(pretrained)
        ...
        for i in range(self.num_stages):
            ...
            if i == 0:
                ...
                for res in sampling_results:
                    new_bbox_feats.append(bbox_feats[res.pos_inds])
                    new_bbox_feats.append(bbox_feats[res.neg_inds])
                bbox_feats = torch.cat(new_bbox_feats)
    ...
    def show_result(self, data, result, **kwargs):
        ...
        super(CascadeRCNNV2, self).show_result(data, result, **kwargs)
