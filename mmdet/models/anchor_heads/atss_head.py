...
from mmdet.core import (AnchorGenerator, atss_target, delta2bbox, force_fp32,
...
class ATSSHead(AnchorHead):
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, centerness, labels, label_weights,
                    bbox_targets, num_total_samples, cfg):
    ...
    def loss(self,
        ...
        losses_bbox = list(map(lambda x: x * self.loss_bbox_weight / bbox_avg_factor, losses_bbox))
    ...
    def get_bboxes_single(self, cls_scores, bbox_preds, centernesses, mlvl_anchors,
