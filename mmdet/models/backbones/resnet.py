    ...
    def __init__(self,
        ...
        if self.with_gcb:
            ...
            if gcb_ratio is not None:
                ...
                gcb_planes = None
            pooling_method = gcb.get('pooling_method', 'att')
            fusion_methods = gcb.get('fusion_methods', 'channel_add')
            fusion_methods = fusion_methods if isinstance(fusion_methods, list) else [fusion_methods]
