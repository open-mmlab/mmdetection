if '_base_':
    ...
    from .yolox_tta import *
from mmdet.models.detectors.yolox import YOLOX
from mmdet.models.data_preprocessors.data_preprocessor import DetDataPreprocessor, BatchSyncRandomResize
...
from mmdet.models.task_modules.assigners.sim_ota_assigner import SimOTAAssigner
from mmdet.datasets.transforms.transforms import Mosaic, RandomAffine, MixUp, YOLOXHSVRandomAug, RandomFlip, Resize, Pad, Resize, Pad
from mmdet.datasets.transforms.loading import FilterAnnotations, LoadAnnotations, LoadAnnotations
...
from mmengine.dataset.sampler import DefaultSampler, DefaultSampler
from mmdet.evaluation.metrics.coco_metric import CocoMetric
from mmengine.optim.optimizer.optimizer_wrapper import OptimWrapper
from torch.optim.sgd import SGD
from mmengine.optim.scheduler.lr_scheduler import CosineAnnealingLR, ConstantLR
from mmdet.engine.hooks.yolox_mode_switch_hook import YOLOXModeSwitchHook
from mmdet.engine.hooks.sync_norm_hook import SyncNormHook
...
train_pipeline = [
    ...
    dict(
        type=MixUp, img_scale=img_scale, ratio_range=(0.8, 1.6),
        pad_val=114.0),
...
train_cfg.merge(dict(max_epochs=max_epochs, val_interval=interval))
...
custom_hooks = [
    dict(
        type=YOLOXModeSwitchHook, num_last_epochs=num_last_epochs,
        priority=48),
