...
from mmdet.datasets.transforms.transforms import Resize, RandomFlip, Pad, Resize, RandomFlip, Pad
from mmcv.transforms.processing import Normalize, MultiScaleFlipAug, Normalize
