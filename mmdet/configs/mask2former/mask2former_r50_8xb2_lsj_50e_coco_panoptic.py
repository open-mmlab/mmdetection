...
from torch.nn.modules.activation import ReLU, ReLU, ReLU
...
from mmdet.models.task_modules.assigners.match_cost import ClassificationCost, CrossEntropyLossCost, DiceCost
...
default_hooks.merge(
    dict(
        checkpoint=dict(
            ...
            max_keep_ckpts=3,
            interval=interval)))
log_processor.merge(dict(type=LogProcessor, window_size=50, by_epoch=False))
