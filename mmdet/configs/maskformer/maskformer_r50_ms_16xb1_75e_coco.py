...
from mmdet.models.task_modules.assigners.match_cost import ClassificationCost, FocalLossCost, DiceCost
...
val_dataloader.merge(dict(batch_size=1, num_workers=1))
