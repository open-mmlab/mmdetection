if '_base_':
    from ..cascade_rcnn.cascade_mask_rcnn_r50_fpn_1x_coco import *
from mmdet.models.backbones.resnest import ResNeSt
from mmdet.models.roi_heads.bbox_heads.convfc_bbox_head import Shared4Conv1FCBBoxHead, Shared4Conv1FCBBoxHead, Shared4Conv1FCBBoxHead
