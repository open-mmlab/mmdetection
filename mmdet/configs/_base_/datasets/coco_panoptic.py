...
from mmdet.datasets.transforms.loading import LoadPanopticAnnotations, LoadPanopticAnnotations
...
from mmdet.evaluation.metrics.coco_panoptic_metric import CocoPanopticMetric, CocoPanopticMetric
# dataset settings
