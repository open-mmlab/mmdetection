...
from mmdet.models.losses.smooth_l1_loss import L1Loss, L1Loss
...
from mmdet.models.task_modules.assigners.max_iou_assigner import MaxIoUAssigner, MaxIoUAssigner
from mmdet.models.task_modules.samplers.random_sampler import RandomSampler, RandomSampler
# model settings
