...
from mmdet.models.detectors.nasfcos import NASFCOS
from mmdet.models.data_preprocessors.data_preprocessor import DetDataPreprocessor
from mmdet.models.backbones.resnet import ResNet
from mmdet.models.necks.nasfcos_fpn import NASFCOS_FPN
...
# dataset settings
train_dataloader.merge(dict(batch_size=4, num_workers=2))
