if '_base_':
    from .decoupled_solo_r50_fpn_3x_coco import *
from mmdet.models.dense_heads.solo_head import DecoupledSOLOLightHead
...
model.merge(
    dict(
        mask_head=dict(
            ...
            scale_ranges=((1, 64), (32, 128), (64, 256), (128, 512), (256,
                                                                      2048)),
            pos_scale=0.2,
