...
from mmdet.datasets.transforms.transforms import PhotoMetricDistortion, RandomCenterCropPad, Resize, RandomFlip, RandomCenterCropPad
...
train_cfg.merge(dict(max_epochs=max_epochs))  # the real epoch is 28*5=140
