...
from torch.nn.modules.activation import SiLU, SiLU, SiLU
...
from mmdet.datasets.transforms.transforms import CachedMosaic, RandomCrop, YOLOXHSVRandomAug, RandomFlip, Pad, CachedMixUp, RandomCrop, YOLOXHSVRandomAug, RandomFlip, Pad, Resize, Pad
...
val_evaluator.merge(dict(proposal_nums=(100, 1, 10)))
