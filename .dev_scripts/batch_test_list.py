...
convnext = dict(
    config='configs/convnext/cascade_mask_rcnn_convnext-s_p4_w7_fpn_giou_4conv1f_fp16_ms-crop_3x_coco.py', # noqa
...
resnet_strikes_back = dict(
    config='configs/resnet_strikes_back/mask_rcnn_r50_fpn_rsb-pretrain_1x_coco.py', # noqa
