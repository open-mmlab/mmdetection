...
The cityscapes annotations have to be converted into the coco format using `tools/data_converters/cityscapes.py`:

```shell
pip install cityscapesscripts
python tools/data_converters/cityscapes.py ./data/cityscapes --nproc 8 --out-dir ./data/cityscapes/annotations
```
