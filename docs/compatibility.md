...
To convert the models trained by MMDetection V1.x to MMDetection V2.0, the users can use the script `tools/convert_models/upgrade_model_version.py` to convert
