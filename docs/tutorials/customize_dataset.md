...
- Since the middle format only have box labels and do not contain the class names, when using `CustomDataset`, users could not filter out the empty GT images through configs but only do this offline.
