...
- *If the deployed model is Faster_RCNN*, please pass `max_shape = None` for the function [delta2bbox](https://github.com/open-mmlab/mmdetection/blob/master/mmdet/core/bbox/coder/delta_xywh_bbox_coder.py#L134) when using pytorch2onnx.py to convert models.
