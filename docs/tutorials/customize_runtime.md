...
We implement a CustomHook named [NumClassCheckHook](https://github.com/open-mmlab/mmdetection/blob/master/mmdet/datasets/utils.py)
to check whether the `num_classes` in head matches the length of
`CLASSSES` in `dataset`.
