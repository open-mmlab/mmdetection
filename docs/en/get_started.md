...
The downloading will take several seconds or more, depending on your network environment. When it is done, you will find two files `rtmdet_l_8xb32-300e_coco.py` and `rtmdet_l_8xb32-300e_coco_20220719_112030-5a0be7c4.pth` in your current folder.
...
```shell
python demo/image_demo.py demo/demo.jpg rtmdet_l_8xb32-300e_coco.py --weights rtmdet_l_8xb32-300e_coco_20220719_112030-5a0be7c4.pth --device cpu
```
