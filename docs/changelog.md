...
**Highlights**
- Support new backbones: [DetectoRS](https://arxiv.org/abs/2006.02334)
- Support new methods: [PointRend](https://arxiv.org/abs/1912.08193), [Generalized Focal Loss](https://arxiv.org/abs/2006.04388), [Dynamic R-CNN](https://arxiv.org/abs/2004.06002)
- Support new dataset: [MMFashion](https://arxiv.org/abs/2005.08847)

**Bug Fixes**
 - Clean up deprecated usage of `register_module()` (#3092, #3161)
 - Fix Dynamic R-CNN constructor (#3163)
 - Fix incorrect check of `scale_factor` (#3162)
 - Fix pretrain bug in NAS FCOS (#3145)
 - Fix `num_classes` in SSD (#3142)
 - Rename RegNet configs (#3143, #3126)
 - Fix FCOS warmup (#3119)
 - Fix `rstrip` in `tools/publish_model.py`
 - Fix bug in RandomFLip (#3119)
