...
for MODEL_NAME in faster_rcnn_r50_fpn_3x faster_rcnn_r101_fpn_3x faster_rcnn_x101_32x4d_fpn_2x faster_rcnn_x101_32x4d_fpn_3x faster_rcnn_x101_64x4d_fpn_1x faster_rcnn_x101_64x4d_fpn_2x faster_rcnn_x101_64x4d_fpn_3x
do
    CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
                                        --nproc_per_node=4 \
                                        --master_port=912 \
