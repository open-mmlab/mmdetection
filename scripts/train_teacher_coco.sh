...
for MODEL_NAME in faster_rcnn_r50_fpn_3x_mstrain
do
    CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
                                        --nproc_per_node=4 \
                                        --master_port=912 \
...
for MODEL_NAME in faster_rcnn_r101_fpn_3x_mstrain faster_rcnn_x101_32x4d_fpn_3x_mstrain faster_rcnn_x101_64x4d_fpn_3x_mstrain
do
    CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
                                        --nproc_per_node=4 \
                                        --master_port=911 \
