...
for MODEL_NAME in faster_rcnn_r50_c4_1x_mstrain_fskd faster_rcnn_r50_dc5_1x_fskd faster_rcnn_r50_fpn_1x_fskd faster_rcnn_r50_fpn_2x_fskd
do
...
for MODEL_NAME in faster_rcnn_x101_32x4d_fpn_1x_fskd faster_rcnn_r101_fpn_1x_fskd faster_rcnn_r101_fpn_2x_fskd
do
    CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
                                        --nproc_per_node=4 \
                                        --master_port=991 \
