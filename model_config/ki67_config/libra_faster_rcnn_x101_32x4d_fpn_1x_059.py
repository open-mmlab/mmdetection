...
test_cfg = dict(
    ...
    rcnn=dict(
        score_thr=0.10,
        # nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.01),  # modified by Lichao Wang
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(type=dataset_type,
                     ann_file=[
                         data_root + 'VOC2007_r1024_n4/ImageSets/Main/trainval_all.txt',
                        #  data_root + 'VOC2007_r1024_n2/ImageSets/Main/trainval_all.txt',
                     ],
                     img_prefix=[
                         data_root + 'VOC2007_r1024_n4/',
                        #  data_root + 'VOC2007_r1024_n2/',
                     ],
                     pipeline=train_pipeline)),
    val=dict(type=dataset_type,
             ann_file=data_root + 'VOC2007_r1024_fov_n1/ImageSets/Main/test_all.txt',
             img_prefix=data_root + 'VOC2007_r1024_fov_n1/',
...
load_from = '/home/wanglichao/mmdetection/experiment/ki67_libra_rcnn/epoch_30_052.pth'
resume_from = None
workflow = [('train', 1)]
