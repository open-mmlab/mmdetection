    ...
    train=dict(
        ...
        dataset=dict(type=dataset_type,
                     ann_file=[
                         ...
                         data_root + 'VOC2007_r1024_n1_part_gan/ImageSets/Main/trainval_all.txt',
                         data_root + 'VOC2007_r1024_n2/ImageSets/Main/trainval_all.txt',
                         data_root + 'VOC2007_r1024_n3/ImageSets/Main/trainval_all.txt',
                     ],
                     img_prefix=[
                         data_root + 'VOC2007_r1024_n1/',
                         data_root + 'VOC2007_r1024_n1_part_gan/',
                         data_root + 'VOC2007_r1024_n2/',
                         data_root + 'VOC2007_r1024_n3/',
                     ],
                     pipeline=train_pipeline)),
    val=dict(type=dataset_type,
             ann_file=data_root + 'VOC2007_r1024_n3/ImageSets/Main/test_all.txt',
             img_prefix=data_root + 'VOC2007_r1024_n3/',
             pipeline=test_pipeline),
    # test=dict(type=dataset_type,
    #           ann_file=data_root + 'VOC2007_r1024_n2/ImageSets/Main/test_all.txt',
    #           img_prefix=data_root + 'VOC2007_r1024_n2/',
    #           pipeline=test_pipeline))
    test=dict(type=dataset_type,
              ann_file=data_root + 'VOC2007_r1024_ERPR_n1/ImageSets/Main/test_all.txt',
              img_prefix=data_root + 'VOC2007_r1024_ERPR_n1/',
              pipeline=test_pipeline))
    # test=dict(type=dataset_type,
    #           ann_file=data_root + 'VOC2007_r1024_n3/ImageSets/Main/test_all.txt',
    #           img_prefix=data_root + 'VOC2007_r1024_n3/',
