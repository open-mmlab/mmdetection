    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=[
                ...
                data_root +'VOC2007_OURS_r1024_TUPAC/ImageSets/Main/trainval_positive.txt',
            ],
            img_prefix=[
                ...
                data_root + 'VOC2007_OURS_r1024_TUPAC/',
            ],
...
log_level = 'INFO'
work_dir = './work_dirs/libra_faster_rcnn_x101_32x4d_fpn_gn_ws_2x_008'
load_from = None
resume_from = None
workflow = [('train', 1)]
