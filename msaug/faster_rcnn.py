...
class FasterRCNN_AUG(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(FasterRCNN_AUG, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
    ...
    def train_step(self, data, optimizer):
        ...
        gt_feats_large = gt_feats_large.view(B, -1)
        gt_feats_small = gt_feats_small.view(B, -1)
        
        consistency_loss = 0.
        if self.distill_param > 0:
            positive_loss = self.calc_consistency_loss(gt_feats_large, gt_feats_small)
