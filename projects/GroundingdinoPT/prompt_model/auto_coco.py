...
class Auto_CocoDataset(BaseDetDataset):
    """Dataset for COCO."""
    ...
    def reset_metainfo(self) -> List[dict]:
        text_list = []
        palette = []
    ...
    def load_data_list(self) -> List[dict]:
        ...
        self.cat_ids = self.coco.get_cat_ids(
            cat_names=self.meta_info['classes'])
    ...
    def parse_data_info(self, raw_data_info: dict) -> Union[dict, List[dict]]:
        ...
        # text = self.meta_info['classes']
        # text_dict = {str(i):v for i,v in enumerate(text)}
        data_info['text'] = self.meta_info['classes']
