...
class BertModelGroundingDINO(BaseModel):
    ...
    def __init__(self,
                 ...
                 use_sub_sentence_present: bool = False,
        ...
        self.use_sub_sentence_present = use_sub_sentence_present
        if self.use_sub_sentence_present:
            assert special_tokens_list is not None, \
                'special_tokens should not be None \
                    if use_sub_sentence_present is True'
