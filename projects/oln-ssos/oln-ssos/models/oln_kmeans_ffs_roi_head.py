...
class OLNKMeansFFSRoIHead(OLNRoIHead):
    ...
    def loss(self, x: Tuple[Tensor], rpn_results_list: InstanceList,
        ...
        if self.with_bbox:  # Sampling results has the pseudo_labels stores in the labels field
            ...
            if 'loss_ood' in bbox_results.keys():
                ...
                losses.update({'loss_nll': bbox_results['loss_nll'] * self.nll_loss_weight})
    ...
    def _ood_forward_train(self, bbox_results, bbox_targets, device):
        ...
        return dict(loss_ood=ood_reg_loss, loss_pseudo_class=loss_pseudo_score, loss_nll=nll_loss)
