...
# configs/grounding_dino_swin-t_pretrain_obj365_goldg.py -o aa --not-show --shuffle
def parse_args():
...
def main():
    ...
    for i in dataset_index[:args.show_num]:
        ...
        print(base_name, dataset_mode, data_sample.text)

        out_file = osp.join(args.output_dir, dataset_mode + '_' + name + '_' + str(i) +
